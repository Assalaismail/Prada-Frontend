...
function ProductImage({ src, websiteName, price }) {
const [isHovered, setIsHovered] = useState(false);

return (
<div>
    <div onMouseEnter={()=> setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
        <img src={isHovered ? src[1] : src[0]} className='products-img' alt={`Product`} />
        <p className='products-websitename'>{websiteName}</p>
...
<div className='productPage'>
    ...
    <div className='subcategory-count'>
        <p className='products-subcategory'>{productsData.subcategory}
        <span className='products-count'>{productsData.product_count} PRODUCTS</span></p>
        <div>
    ...
    <div className="product-container">
        ...
        <ProductImage key={index} src={product.images} websiteName={product.website_name} price={product.price} />
        ))}
    </div>
